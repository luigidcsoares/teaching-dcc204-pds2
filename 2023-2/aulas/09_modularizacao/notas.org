...
INCLUDE := -I include/
# Caminho para o doctest
DOCTEST += -I ../
# Nome da pasta onde estão os códigos fonte
SRC_DIR := src
# Nome da pasta onde estão os códigos de teste
TEST_DIR := test
# Nome da pasta onde serão armazenados arquivos binários
BIN_DIR := bin
