...
- Inicialmente, a lista era: base \harr 1 \harr 2 \harr base
- Após a atribuição: base \rarr ↻1 \rarr base e 1 \larr 2 \harr base (isto é, o nó 1 agora aponta para ele mesmo)
