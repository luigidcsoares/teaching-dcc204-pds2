#+title: Notas de Aula - 05 Lista Encadeada
...
#+begin_src C++ :tangle include/linked_list.hpp :noweb strip-export
#pragma once
...
#+name: test_push_before
#+begin_src C++ :flags -std=c++17 -I ../ -I include/ :exports code
...
#+name: src_list_push_before
#+begin_src C++ :exports code :noweb-ref src_list
...
#+begin_src C++ :exports code :tangle src/linked_list.cpp :noweb yes
#include "linked_list.hpp"

<<src_list_push_before>>
#+end_src

Resultado do caso de teste, após a implementação:

#+call: test_push_before() :exports both :flags -std=c++17 -I ../ -I include src/linked_list.cpp :results scalar

Agora, vamos passar para a inserção *após* um determinado nó

#+name: _test_push_after
#+begin_src C++ :flags -std=c++17 -I ../ -I include/ src/linked_list.cpp :exports code
...
#+name: test_push_after
#+begin_src C++ :flags -std=c++17 -I ../ -I include/ src/linked_list.cpp :noweb yes :exports none
<<test_push_before>>
<<_test_push_after>>
#+end_src
...
#+begin_src C++ :exports code :tangle src/linked_list.cpp :noweb-ref src_list
...
#+call: test_push_after() :exports both :flags -std=c++17 -I ../ -I include src/linked_list.cpp :results scalar

E a inserção no início?

#+name: _test_push_front
#+begin_src C++ :flags -std=c++17 -I ../ -I include/ src/linked_list.cpp :exports code
...
#+call: test_push_front() :exports both :flags -std=c++17 -I ../ -I include src/linked_list.cpp :results scalar

A inserção no final segue a mesma ideia:

#+name: _test_push_back
#+begin_src C++ :flags -std=c++17 -I ../ -I include/ src/linked_list.cpp :exports code
...
#+call: test_push_back() :exports both :flags -std=c++17 -I ../ -I include src/linked_list.cpp :results scalar
...
#+name: test_assign
#+begin_src C++ :flags -std=c++17 -I ../ -I include/ src/linked_list.cpp :noweb yes :exports results :results scalar
<<test_push_before>>
<<_test_push_after>>
<<_test_push_front>>
<<_test_push_back>>
...
===============================================================================
/tmp/babel-leVvwe/C-src-koqRdo.cpp:90:
TEST CASE:  IntLinkedList::Node => Copiando um nó para outro

/tmp/babel-leVvwe/C-src-koqRdo.cpp:107: ERROR: CHECK_EQ( node1.prev(), &list.end() ) is NOT correct!
  values: CHECK_EQ( 0x134a9e0, 0x7fffe8baf760 )

/tmp/babel-leVvwe/C-src-koqRdo.cpp:108: ERROR: CHECK_EQ( node1.next(), &node2 ) is NOT correct!
  values: CHECK_EQ( 0x7fffe8baf760, 0x134aa00 )
...
#+begin_src C++ :tangle include/linked_list_v2.hpp :noweb yes :exports none
#pragma once
...
#+begin_src C++ :exports none :tangle src/linked_list_v2.cpp :noweb yes
